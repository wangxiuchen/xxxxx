...
class DailyAppUsageDaoTest {
    ...
    @Test
    fun clearAllUsageData_removesDailyUsageAndAppInfoRows() = runBlocking {
        ...
        assertNull(database.appInfoDao().getByPackageName("com.example.mail"))
    }
